            ...
            {isOptimized && (
                <div className="bg-primary border-4 border-foreground p-6 md:p-8 lg:p-10 flex flex-col md:flex-row items-start md:items-center justify-between shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] mt-[-1rem] lg:mt-[-2rem] mb-4">
                    <div className="flex-1">
                        ...
                        <h2 className="font-space font-black text-3xl md:text-4xl lg:text-5xl uppercase tracking-tighter text-foreground leading-none mt-4">Versão otimizada <br className="hidden md:block"/> disponível.</h2>
                    </div>
                    <Button 
